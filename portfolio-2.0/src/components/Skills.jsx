...
import backgroundImg from '../assets/skillsBackground.jpg'

const Skills = () => {
  return (
    <div name='skills' className='bg-[#16171A] w-full text-gray-300 skills' style={{backgroundImage: `url(${backgroundImg})`}}>
        {/*Container*/}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full text-gray-300'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 text-gray-300 border-[#20A2F6]'>Skills</p>
                <p className='py-4'>// These are the technologies I've worked with</p>
            </div>

            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
                <div className='flex flex-col font-bold justify-evenly shadow-md shadow-[#040c16] hover:translate-y-[-4px] duration-300 h-[150px]'>
                    <img src={HTML} alt="HTML Icon" className='w-20 mx-auto'/>
                    <p className="mt-5">HTML</p>
                </div>
                <div className='flex flex-col bg-white text-black font-bold justify-evenly shadow-md shadow-[#040c16] hover:translate-y-[-4px] duration-300 h-[150px]'>
